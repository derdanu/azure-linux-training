...
for i in A B C D E; do for j in 1 3 4 9; do for k in $(seq -w 1 ${j} 9999) ; do /opt/azure-linux-training-master/files/ADUMMY >> /opt/azure-linux-training-master/files/${i}${k};done; done; done;
